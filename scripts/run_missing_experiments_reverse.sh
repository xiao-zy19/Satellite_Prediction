#!/bin/bash
# ============================================================================
# 补充实验运行脚本 - P0/P1/P2 全部缺失实验 (反向顺序)
# run_missing_experiments_reverse.sh
#
# 目的: 运行论文完成所需的所有缺失实验
#
...
LOG_DIR="${PROJECT_DIR}/logs/missing_experiments_rev"
RESULT_DIR="${PROJECT_DIR}/results"
STATUS_DIR="${PROJECT_DIR}/.run_status_missing_rev"
SESSION_NAME="missing_exp_rev"
...
tmux send-keys -t "$SESSION_NAME:monitor" "echo '=== 补充实验监控 (P0/P1/P2 反向顺序) ==='" Enter
